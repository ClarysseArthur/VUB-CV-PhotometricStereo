...
Our error measure quantifies the discrepancy between the true surface map $\mathbf{T}$ and the surface map $\mathbf{S}$ estimated by using their $\ell_2$ distance.
...
Figure \ref{fig:ell2-error} is a visualized version of the identical scores, where we can draw the same conclusion.
